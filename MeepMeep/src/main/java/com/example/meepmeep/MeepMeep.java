...
public class MeepMeep {
    public static void main(String[] args) {
        ...
        RoadRunnerBotEntity backstage = new DefaultBotBuilder(meepMeep)
                ...
                .followTrajectorySequence(drive ->
                        drive.trajectorySequenceBuilder(new Pose2d(12, -61, Math.toRadians(270)))
                                ...
                                .waitSeconds(2.5)
                                .splineToLinearHeading(new Pose2d(-41, -58.5, Math.toRadians(0)), Math.toRadians(359))
        ...
        RoadRunnerBotEntity newbackstage = new DefaultBotBuilder(meepMeep)
                .setColorScheme(new ColorSchemeRedDark())
                .setConstraints(60,60,Math.toRadians(180), Math.toRadians(180), 15)
                        .followTrajectorySequence(drive ->
                                drive.trajectorySequenceBuilder( new Pose2d(12,-60, Math.toRadians(270)))
                                        .back(15)
                                        .splineToLinearHeading(new Pose2d(37, -25, Math.toRadians(180)), Math.toRadians(0))
                                        .waitSeconds(2)
        ...
        RoadRunnerBotEntity newbackstage2 = new DefaultBotBuilder(meepMeep)
                .setColorScheme(new ColorSchemeRedDark())
                .setConstraints(60,60,Math.toRadians(180), Math.toRadians(180), 15)
                .followTrajectorySequence(drive ->
                        drive.trajectorySequenceBuilder( new Pose2d(12,-60, Math.toRadians(270)))
